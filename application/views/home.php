                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <div class="container">
                                                <h4 class="font-weight-bolder"><b>Total pengunjung</b></h4>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            <!-- <img src="img_avatar.png" alt="Avatar" style="width:100%"> -->
                                            <div class="container">
                                                <h4 class="font-weight-bolder"><b>Pengunjung hari ini</b></h4>
                                                <p><strong> <?= $totalHariIni ?> </strong></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section id="services" class="services section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    ...
                    <p>Layanan Online Perpustakaan</p>
                </div>
  ...
  if($rowCount % $numOfCols == 0) { ?> <div class="row"> <?php } 
    $rowCount++; ?>
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                        <a href="<?= $fasilitas->link ?>" target="_blank">
                        <div class="icon-box">
                            <div class="icon"><i class="<?= $fasilitas->icon_fasilitas ?>"></i></div>
                            <br>
                            <h4 class="title"><a href="<?= $fasilitas->link ?>" target="_blank"><?= $fasilitas->judul_fasilitas ?></a></h4>
        ...
        <section id="team" class="team">
            <div class="container">
                ...
                <div class="row" style="justify-content: center">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in"
                        data-aos-delay="100">
                        <div class="member">
                            <div class="member-img">
                                <img src="<?= base_url('assetsDashboard/img/user/'.$user->gambar_user) ?>"
                                    style="width: 408px; height: 306px; object-fit:cover" class="img-fluid" alt="">
                                <div class="social">
