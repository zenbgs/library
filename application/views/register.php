...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="http://perpustakaanasia.blogspot.com/favicon.ico">
    <link href="http://perpustakaanasia.blogspot.com/favicon.ico" rel="icon" type="image/x-icon">
    <title>
        Sign Up | Perpustakaan Asia
    </title>
    <!--     Fonts and icons     -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet" />
    <!-- Nucleo Icons -->
    <link href="<?= base_url() ?>assetsDashboard/css/nucleo-icons.css" rel="stylesheet" />
    <link href="<?= base_url() ?>assetsDashboard/css/nucleo-svg.css" rel="stylesheet" />
    <!-- Font Awesome Icons -->
    <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
    <link href="<?= base_url() ?>assetsDashboard/css/nucleo-svg.css" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="<?= base_url() ?>assetsDashboard/css/soft-ui-dashboard.css?v=1.0.3" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show  bg-gray-100">
                ...
                <ul class="navbar-nav navbar-nav-hover ms-auto">
                    ...
                    <li class="nav-item dropdown dropdown-hover mx-2">
                        <a href="<?= base_url('index.php/login') ?>"
                            class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center "
                            id="dropdownMenuAccount" aria-expanded="false">
                            Masuk
    ...
    <section class="min-vh-100 mb-8">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('<?= base_url() ?>assetsDashboard/img/login/gambarLogin.jpg');">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Daftar Akun!</h1>
                        <p class="text-lead text-white">Sistem informasi management perpustakaan Institut Asia Malang
                        </p>
                    </div>
                </div>
            </div>
                ...
                <p class="text-sm font-weight-bold mb-2 text-secondary text-border d-inline z-index-2 bg-white px-3">
                  or
                        ...
                        <div class="card-body">
                            <form role="form text-left">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Contoh: Zain Bagus"
                                        aria-label="Name" aria-describedby="email-addon">
                                </div>

                                <label>Email</label>
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Contoh: ZainBagus@gmail.com"
                                        aria-label="Name" aria-describedby="email-addon">
                                </div>
                  ...
                  <label class="form-check-label" for="flexCheckDefault">
                    I agree the <a href="javascript:;" class="text-dark font-weight-bolder">Terms and Conditions</a>
                                ...
                                <p class="text-sm mt-3 mb-0">Sudah memiliki akun? <a
                                        href="<?= base_url('index.php/login') ?>"
                                        class="text-info text-gradient font-weight-bolder">Masuk</a></p>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-8 mx-auto text-center mt-1">
                    <p class="mb-0 text-secondary">
                        ...
                        </script> UPT-SI <a class="font-weight-bold">Institut Asia Malang.</a>
                    </p>
                </div>
            </div>
        </div>
