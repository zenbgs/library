                ...
                <nav
                  ...
                  <a class="nav-link me-2" href="../pages/profile.html">
                    ...
                    Profile
                                ...
                                <!-- <li class="nav-item">
                                    <a class="nav-link me-2" href="<?= base_url('index.php/register') ?>">
                                        Daftar
                                    </a>
                                </li> -->
                                <!-- <li class="nav-item">
                    ...
                    <div class="row">
                            ...
                            <div class="card card-plain mt-8">
                                ...
                                ?>
                                    <div class="alert alert-success text-white alert-dismissible fade show"
                                        role="alert">
                                        <span class="alert-text"> <?= $this->session->flashdata('sukses') ?></span>
                                    ...
                                    <?php
                                if($this->session->flashdata('gagal_nonaktif')){
                                ?>
                                    <div class="alert alert-danger text-white alert-dismissible fade show"
                                        role="alert">
                                        <span class="alert-text"> <?= $this->session->flashdata('gagal_nonaktif') ?></span>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    ...
                                    <div class="mb-3">
                                        <input type="text" name="username" class="form-control"
                                            placeholder="Contoh: ZainBagus" aria-label="Username"
                                            aria-describedby="username-addon" required>
                                    </div>
                                    <label>Password</label>
                                    <div class="mb-3">
                                        <input type="password" name="password" class="form-control"
                                            placeholder="Password Anda" aria-label="Password"
                      ...
                      <label class="form-check-label" for="rememberMe">Remember me</label>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0">Masuk</a>
                                    </div>
                                    <?= form_close() ?>
                                </div>
