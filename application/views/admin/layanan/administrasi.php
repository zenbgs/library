...
<body class="g-sidenav-show  bg-gray-100">
                ...
                <div class="col-12 col-xl-12">
                    <div class="card h-100">
                        <div class="card-header pb-0 p-3">
                            <h6 class="mb-0">Layanan Administrasi</h6>
                        </div>
                        <div class="card-body p-3">
                        <?php if($this->session->flashdata('sukses')){ ?>
                        <div class="alert alert-success text-white alert-dismissible fade show" role="alert">
                                <span class="alert-icon"><i class="ni ni-like-2"></i></span>
                                <span class="alert-text"><strong>Sukses!</strong> Berhasil merubah layanan administrasi!</span>
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                        <?php } ?>
                        <?= form_open_multipart(base_url('index.php/admin/layanan/simpan/'.$layanan->id_layanan)); ?>
                                
                                <div class="form-group">
                                    <!-- <label for="editor-halaman-1">Misi</label> -->
                                    <textarea class="form-control" name="administrasi" id="editor-halaman-1" rows="3"><?= $layanan->layanan_administrasi ?></textarea>
                                </div>
                                <div class="form-group">
    ...
    var selector = '.navbar-nav > .nav-item:nth-child(4) > .collapse';
    var selector2 = '.navbar-nav > .nav-item:nth-child(4) > .collapse > ul > .nav-item:nth-child(2)';
    var selector3 = '.navbar-nav > .nav-item:nth-child(4) > .collapse > ul > .nav-item:nth-child(2) > .nav-link';
    var selector4 = '.navbar-nav > .nav-item:nth-child(4) > .nav-link';
    var selector5 = '.navbar-nav > .nav-item:nth-child(4) > .nav-link';
