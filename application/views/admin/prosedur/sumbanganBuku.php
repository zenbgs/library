...
<body class="g-sidenav-show  bg-gray-100">
                ...
                <div class="col-12 col-xl-12">
                    <div class="card h-100">
                        <div class="card-header pb-0 p-3">
                            <h6 class="mb-0">Prosedur Sumbangan Buku</h6>
                        </div>
                        <div class="card-body p-3">
                        <?php if($this->session->flashdata('sukses')){ ?>
                        <div class="alert alert-success text-white alert-dismissible fade show" role="alert">
                                <span class="alert-icon"><i class="ni ni-like-2"></i></span>
                                <span class="alert-text"><strong>Sukses!</strong> Berhasil merubah prosedur sumbangan buku!</span>
                        ...
                        <?= form_open_multipart(base_url('index.php/admin/prosedur/simpan/'.$prosedur->id_prosedur)); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="sumbangan_buku" id="editor-halaman-1" rows="3"><?= $prosedur->sumbangan_buku ?></textarea>
                                </div>
                                <div class="form-group">
    ...
    var selector2 = '.navbar-nav > .nav-item:nth-child(5) > .collapse > ul > .nav-item:nth-child(2)';
    var selector3 = '.navbar-nav > .nav-item:nth-child(5) > .collapse > ul > .nav-item:nth-child(2) > .nav-link';
