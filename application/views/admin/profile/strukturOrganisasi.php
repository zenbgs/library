...
<body class="g-sidenav-show  bg-gray-100">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="alert alert-success text-white alert-dismissible fade show" role="alert">
                                ...
                                <span class="alert-text"><strong>Sukses!</strong> Berhasil merubah struktur
                                    organisasi!</span>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="struktur_organisasi" id="editor-halaman-1"
                                    rows="3"><?= $profile->struktur_organisasi ?></textarea>
                            </div>
                            <div class="form-group">
    ...
    var selector2 = '.navbar-nav > .nav-item:nth-child(3) > .collapse > ul > .nav-item:nth-child(1)';
    var selector3 = '.navbar-nav > .nav-item:nth-child(3) > .collapse > ul > .nav-item:nth-child(1) > .nav-link';
