                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            ...
                            <a href="<?= base_url('index.php/admin/berita/tambah_berita') ?>"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="<?= base_url('assetsDashboard/img/user/'.$berita->gambar_user) ?>"
                                                            class="avatar avatar-sm me-3" alt="user1">
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm"><?= $berita->nama_user ?></h6>
                                                        <p class="text-xs text-secondary mb-0">
                                                            <?= $berita->jabatan_user ?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold"><?= $berita->tanggal_berita ?></span>
                                            </td>
                                            <td class="align-middle">
                                            <?php
                                            if($berita->status_berita != 2){
                                            ?>
                                                <a href="<?= base_url('index.php/berita/read/'.$berita->slug_berita) ?>"
                                                    class="text-gradient text-success font-weight-bold text-xs" data-original-title="Lihat berita">
                                                    View
                                                </a>
                                                &nbsp;
                                            <?php } ?>
                                                <a href="<?= base_url('index.php/admin/berita/edit/'.$berita->id_berita) ?>"
                                                ...
                                                <a href="javascript:;"
                                                    ...
                                                    data-bs-target="#hapus<?= $berita->id_berita ?>">
                                                    Hapus
                                                </a>
