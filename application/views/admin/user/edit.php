                ...
                <div class="col-12 col-xl-6">
                    <div class="card h-100">
                        ...
                        <div class="card-body p-3">
                            <?= form_open_multipart(base_url('index.php/admin/user/edit/'.$user->id_user)); ?>
                            <div class="form-group">
                                <label for="nama">Nama User</label>
                                <input class="form-control" placeholder="Contoh: Zain Bagus" value="<?= $user->nama_user ?>" name="nama" type="text" id="nama" required>
                            </div>
                            <div class="form-group">
                                <label for="username">Username</label>
                                <input class="form-control" placeholder="Contoh: ZenBgs23" value="<?= $user->username ?>" name="username" type="text" id="username" required>
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input class="form-control" placeholder="Jangan diisi jika tidak ingin merubah password!" name="password" type="password" id="password">
                            </div>
                ...
                <div class="col-12 col-xl-6">
                    <div class="card h-100">
                        ...
                        <div class="form-group">
                                ...
                                <input class="form-control" value="<?= $user->jabatan_user ?>" placeholder="Contoh: Bagian penanganan masalah" name="jabatan" type="text" id="username" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="akses" name="akses" class="form-control" required>
                                    ...
                                    <option value="2" <?php if($user->akses_user == "2") { echo "selected"; } ?>>Admin Biasa</option>
                                </select>
                            </div>
                            <br>
